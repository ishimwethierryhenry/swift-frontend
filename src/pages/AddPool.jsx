...
export const AddPool = () => {
  ...
  const generatePDFReport = () => {
    ...
    const htmlContent = `
      ...
      <html>
        <head>
          <title>Swimming Pools Report - SWIFT</title>
          <style>
            body { 
            ...
            .header { 
              text-align: center; 
              margin-bottom: 40px; 
              background: linear-gradient(135deg, #00bcd4, #2196f3); /* Updated to match logo */
              color: white; 
              padding: 30px; 
              border-radius: 20px; 
              box-shadow: 0 20px 40px rgba(0, 188, 212, 0.3); /* Updated shadow */
              position: relative;
              overflow: hidden;
            }
            ...
            .logo-frame { 
              ...
              width: 100px; 
              height: 100px; 
              background: linear-gradient(135deg, #00bcd4, #2196f3); /* Updated to match your app logo colors */
              border-radius: 25px; 
              display: flex; 
              align-items: center; 
              justify-content: center; 
              box-shadow: 0 15px 35px rgba(0,188,212,0.4); /* Updated shadow color */
              margin-right: 20px;
            ...
            .logo-overlay { 
              position: absolute; 
              inset: 10px; 
              background: linear-gradient(135deg, rgba(0, 188, 212, 0.2), rgba(33, 150, 243, 0.2)); /* Updated overlay colors */
              border-radius: 15px; 
            }
            ...
            .report-title { 
              ...
              font-weight: 800; 
              margin: 0 0 30px; 
              background: linear-gradient(135deg, #00bcd4, #2196f3); /* Updated gradient */
              -webkit-background-clip: text;
              -webkit-text-fill-color: transparent;
              background-clip: text;
              text-shadow: 0 5px 15px rgba(0, 188, 212, 0.2); /* Updated shadow */
              position: relative;
            }
            ...
            .report-title::after {
              ...
              width: 200px;
              height: 4px;
              background: linear-gradient(135deg, #00bcd4, #2196f3); /* Updated underline */
              border-radius: 2px;
              box-shadow: 0 3px 10px rgba(0, 188, 212, 0.3); /* Updated shadow */
            }
            ...
            .info-item {
              ...
              border-top: 3px solid #00bcd4; /* Updated border color */
            }
            ...
            th { 
              background: linear-gradient(135deg, #00acc1, #1976d2); /* Updated header gradient */
              color: white; 
              padding: 20px 15px; 
              font-weight: 700; 
              text-transform: uppercase;
            ...
            .footer::before {
              ...
              right: 0;
              height: 4px;
              background: linear-gradient(135deg, #00bcd4, #2196f3); /* Updated footer line */
            }
        ...
        <body>
          <div class="header">
            <div class="logo-container">
              <div class="logo-frame">
                ...
                <div style="display: none; color: #2563eb; font-size: 36px; font-weight: bold; align-items: center; justify-content: center; position: absolute; inset: 0;">S</div>
              </div>
              <div>
          ...
          <div class="content">
            <h1 class="report-title">Swimming Pools Report</h1>
            ...
            <div class="header-info">
              <div class="info-grid">
                ...
                <div class="info-item">
                  <div class="info-label">Total Pools</div>
                  <div class="info-value">${filteredPools.length}</div>
                </div>
                <div class="info-item">
              ...
              <table>
                ...
                <tbody>
                  ${filteredPools.map((pool, index) => `
                    <tr>
                      <td class="pool-name">${pool.name || 'N/A'}</td>
                      <td>${pool.location || 'N/A'}</td>
                      <td>${pool.l || 'N/A'}</td>
                      <td>${pool.w || 'N/A'}</td>
                      <td>${pool.depth || 'N/A'}</td>
                      <td class="operator-name">${getOperatorNameById(pool.assigned_to) || 'Unassigned'}</td>
                    </tr>
                  `).join('')}
                </tbody>
              </table>
