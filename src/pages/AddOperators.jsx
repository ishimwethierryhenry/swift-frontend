                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className={`transition-all duration-700 delay-1100 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                      <label className="block text-white font-semibold mb-2 text-lg">First Name</label>
                      <input
                        type="text"
                        name="fname"
                        id="fname"
                    ...
                    <div className={`transition-all duration-700 delay-1200 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
                      <label className="block text-white font-semibold mb-2 text-lg">Last Name</label>
                      <input
                        type="text"
                        name="lname"
                        id="lname"
                  ...
                  <div className={`transition-all duration-700 delay-1300 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                    <label className="block text-white font-semibold mb-2 text-lg">Email Address</label>
                    <input
                      type="text"
                      name="email"
                      id="email"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className={`transition-all duration-700 delay-1400 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                      <label className="block text-white font-semibold mb-2 text-lg">Phone Number</label>
                      <input
                        type="text"
                        name="phone"
                        id="phone"
                    ...
                    <div className={`transition-all duration-700 delay-1500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                      <label className="block text-white font-semibold mb-2 text-lg">Gender</label>
                      <select
                        name="gender"
                        onChange={handleInput}
                      ...
                      >
                        ...
                        <option value="Other" className="bg-slate-800">Prefer Not to Say</option>
                      </select>
                      {errors.gender && (
                        <span className="text-red-400 text-sm mt-1 block">{errors.gender}</span>
                      )}
                    </div>
                  </div>
