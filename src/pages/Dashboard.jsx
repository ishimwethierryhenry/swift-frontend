// // src/pages/Dashboard.jsx - UPDATED WITH POOL MONITOR REDIRECT SOLUTION
...
//   // Get limited pools for dashboard display (max 3)
//   const getDisplayPools = () => {
//     const maxPools = 3;
//     return pools.slice(0, maxPools);
//   };

//   // Check if we need to show "View All" message
//   const shouldShowViewAllMessage = () => {
//     return pools.length > 3;
//   };
...
//                         Showing {Math.min(3, pools.length)} of {pools.length} total pools • Click "START TEST" to open Pool Monitor
//                       </p>
//                     </div>
...
//                       <p className="font-semibold text-base sm:text-lg text-cyan-300">
//                         Showing {Math.min(3, pools.length)} of {pools.length} pools under your care • Click "START TEST" to open Pool Monitor
//                       </p>
//                     </div>
//                     <div className="mt-3 sm:mt-0">
//                       <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center animate-pulse">
...
//                         Showing {Math.min(3, operators.length)} of {operators.length} active operators
//                       </p>
//                     </div>
//                     <div className="mt-3 sm:mt-0">
...
//               {/* System Status Card */}
//               {(userRole === "operator" || userRole === "overseer") && (
//                 <div className="relative group">
...
// src/pages/Dashboard.jsx - UPDATED WITH 3-RECORD LIMIT FOR POOL OPERATORS
...
export const Dashboard = () => {
  ...
  // Get limited operators for dashboard display (max 3)
  const getDisplayOperators = () => {
    const maxOperators = 3;
    return operators.slice(0, maxOperators);
  };

  // Check if we need to show "View All" message for pools
  const shouldShowViewAllPoolsMessage = () => {
    return pools.length > 3;
  };

  // Check if we need to show "View All" message for operators
  const shouldShowViewAllOperatorsMessage = () => {
    return operators.length > 3;
  };
